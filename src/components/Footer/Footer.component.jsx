                ...
                <div className="mt-3">
                    ...
                    <div className="d-flex justify-content-center s-media">
                        <div className="m-1 text-center">
                            <a href="https://www.instagram.com/street_thenics/" target="_blank" rel="noreferrer">
                        ...
                        <div className="m-1 text-center">
                            <a href="https://www.facebook.com/Street-thenics-104141605305767" target="_blank" rel="noreferrer">
                                <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="m-1 text-center">
                            <a href="https://twitter.com/StreetThenics?s=08" target="_blank" rel="noreferrer">
                                <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
