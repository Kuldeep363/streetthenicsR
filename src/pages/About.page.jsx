...
function About() {
  return (
    <div className="myContainer m-top d-flex align-items-center" id='about'>
        <div>
            <h2 className="mt-5"> <strong>Street Thenics</strong> </h2>
            <h2 className="mt-3">
            Street Thenics was founded in 2021 by fitness enthusiasts who wanted to make a difference. We are based in INDIA, and our mission is to empower every individual with a healthy lifestyle. We have created an web-based fitness platform and tried to reach out to as many people as possible by providing free services.
            We believe that when we have a healthy environment, we can all thrive. We offer completely free services for an individual which include different types of exercises for every body parts, and informative articles on different topics related to health.
            </h2>
            ...
            <h2 className="mt-5">
                -- Team <strong>Street Thenics</strong>
            </h2>
